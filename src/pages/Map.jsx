...
import Adrarimg from "../images/adrarimage.jpg";
import Algerimg from "../images/voyage-famille-alger (1).webp";
import Annabaimg from "../images/kayak-annaba.jpg";
import Oranimg from "../images/oran.jfif";
import avions from "../images/Vector.png";

/********************************/

const onWilayaClick = (wilaya, data) => {
  return <div></div>;
};
...
const Adrar = () => {
  const latitude = 28.01141226999431;
  const longitude = -0.17932853020326725;
  const handleClick = () => {
    const url = `/map/${latitude}/${longitude}`;
    window.location.href = url;
  };
  return (
    <div className="hellooo">
      <p>Bienvenue dans la wilaya d'ADRAR</p>
      <img src={Adrarimg} alt='adrar'></img>
      <button onClick={handleClick}>Allez a Adrar</button>
    </div>
  );
};
...
const Alger = () => {
  const latitude = 36.7438565292278;
  const longitude = 3.088500543694011;
  const handleClick = () => {
    const url = `/map/${latitude}/${longitude}`;
    window.location.href = url;
  };
  return (
    <div className="hellooo">
      <p>Bienvenue dans la wilaya d'ALGER</p>
      <img src={Algerimg} alt='alger'></img>
      <button onClick={handleClick}>Allez a Alger</button>
    </div>
  );
};
...
const Annaba = () => {
  const latitude = 36.91503387545803;
  const longitude = 7.7441169860547365;
  const handleClick = () => {
    const url = `/map/${latitude}/${longitude}`;
    window.location.href = url;
  };
  return (
    <div className="hellooo">
      <p>Bienvenue dans la wilaya d'ANNABA</p>
      <img src={Annabaimg} alt='annaba'></img>
      <button onClick={handleClick}>Allez a Annaba</button>
    </div>
  );
};
...
const Oran = () => {
  const latitude = 35.699379092346696;
  const longitude = -0.6395698995231541;
  const handleClick = () => {
    const url = `/map/${latitude}/${longitude}`;
    window.location.href = url;
  };
  return (
    <div className="hellooo">
      <p>Bienvenue dans la wilaya d'ORAN</p>
      <img src={Oranimg} alt='oran'></img>
      <button onClick={handleClick}>Allez a Oran</button>
    </div>
  );
};
...
/******************************** */
const color = "#6FB1B4";
const HoverColor = "#274B58";
const stroke = "#fff";
const hoverStroke = "#274B58";
const height = "550px";
const width = "550px";
...
export const Map = () => {
  ...
  useEffect(() => {
    if (selectedWilaya) {
      window.location.href = selectedWilaya;
    }
  }, [selectedWilaya]);
  return (
    <div className="carteinteractive">
      <div className="cartetext">
        <h1 className="text-animation">Bienvenue dans la carte AlSafir ! </h1>
        <h3>Choisisez wilaya depuis la carte d'Algérie ou bien ici </h3>
        <select value={selectedWilaya} onChange={handleChange}>
          <option value="">Sélectionnez Wilaya a visiter</option>
          <option value="/map/36.7438565292278/3.088500543694011" >Alger</option>
          <option value="/map/28.01141226999431/-0.17932853020326725">Adrar</option>
          <option value="/map/36.91503387545803/7.7441169860547365">Annaba</option>
          <option value="/map/35.699379092346696/-0.6395698995231541">Oran</option>
        </select>
        <img src={avions} alt='avions'></img>
      </div>
      <div className="container">
        ...
        >
          ...
          <g onClick={() => onWilayaClick("Chlef", data["Chlef"])}>
            <title className="hovver">{data["Chlef"] ?? ""}</title>
            <path
              className="state"
              id="_x30_2_Chlef"
              fill={color}
	...
	322.059,-42.826 324.879,-38.166 341.139,-32.046 344.121,-29.926 352.139,-22.086 "
          ...
          <g
            onClick={() =>
              onWilayaClick("Oum El Bouaghi", data["Oum El Bouaghi"])
            }
          >
	...
	l2.69,2.506l1.294,6.848l-0.152,1.792l-2.392,0.982L473.455-204.288L473.455-204.288z"
          ...
          <g
            onClick={() =>
              onWilayaClick("Sidi Bel Abbès", data["Sidi Bel Abbès"])
            }
          >
	...
	"
          ...
          <g
            onClick={() =>
              onWilayaClick("Aïn Témouchent", data["Aïn Témouchent"])
            }
          >
